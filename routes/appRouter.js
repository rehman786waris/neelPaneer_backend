...
router.patch("/:id/discount",authenticate, authController.updateDiscount);
...
// ---------------------- PAYMENTS ----------------------
router.get('/payments-list/:id', authenticate, paymentController.listSavedCards);         // cash / fetch card
